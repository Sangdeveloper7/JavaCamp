	...
	*/
	...
	void printReport(char mn[10][20], int mr[10], int mc, char wn[10][20], int wr[10], int wc)
	{
		...
		// 처음 로직을 구현할 때 드는 생각은 코드를 이해하여야 이 함수를 작성 할 수 있다는 것이었습니다. 각각의 배열의 의미를 알아보고 코드를 작성해 보았지만
		// 인원수가 2명 이상인 경우에도 한 호실에 추가되는 상황이 발생하여 원인을 찾아본 결과 인원이 호실에 들어가고도 +1 해주는 코드가 없어 추가하였습니다. 
	}
